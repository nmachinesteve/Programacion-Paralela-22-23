...
<br>
<br>
En el archivo adjunto _puente.pdf_ se ven las ideas del problema y se muestra una solución sencilla. <br>
En el archivo _practica2.py_ se puede ver el desarrollo implementado en Python. 
